...
function turnGetServer() {
	...
	var i = 0;
	return new Promise(function(resolve,reject) {
		while (i < servers2.length) {
			checkTURNServer(servers2[i], 5000).then(function(result) {
				if (!result) {
					resolve(result);
				}
			});
...
var servers2 = [
	...
	{url:'stun:stun.stun:stunprotocol.org:3478'},
	...
	{url:'stun:stun.voipstun:stunt.com:3478'},
